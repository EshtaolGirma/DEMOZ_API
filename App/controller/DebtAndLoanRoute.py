...
from App.Service.LoanHandler import GetListOfLoans, CreateLoanRecord, GetLoanDetail, DeleteLoan, UpdateLoanDetail
...
class LoanRecords(Resource):
    ...
    def post(self):
        ...
        """
        return CreateLoan(request, current_user.id)
...
class NewLoanTransaction(Resource):
    ...
    def post(self, user_id, loan_id, request):
        """
        Collect loan payment
        """
        return "CreateLoanCollection(user_id, loan_id, request)"
...
class LoanTransaction(Resource):
    ...
    def delete(self, user_id, loan_collection_id):
        """
    ...
    @api.expect(loan_collection)
    def put(self, user_id, loan_collection_id):
        """
